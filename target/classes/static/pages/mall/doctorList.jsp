...
<link rel="stylesheet" href="${basePath}mall_resource/css/doctorList.css">
...
<div class="ps-products-wrap">
			...
			<div class="doctor padding-20" style="position: relative;">
				<!-- <form class="form-inline">
					<label class="control-label ">城市</label> <select
						class="form-control city city_doc">
						<option value="-1">请选择城市</option>

						<option value="上海">上海</option>
						<option value="北京">北京</option>
					</select> <label class="control-label">科室</label> <select
						class="form-control keshi">
						<option>请选择科室</option>

						<option value="1">呼吸科</option>
						<option value="2">消化科</option>
						<option value="3">肾内科</option>
						<option value="4">血液科</option>
						<option value="5">内分泌科</option>
						<option value="6">肿瘤科</option>
						<option value="7">普外科</option>
						<option value="8">神经外科</option>
						<option value="9">胸外科</option>
						<option value="10">泌尿外科</option>
						<option value="14">骨科</option>
						<option value="15">妇科</option>
						<option value="16">眼耳鼻喉科</option>
						<option value="17">口腔科</option>
						<option value="18">皮肤科</option>
						<option value="19">中医科</option>
						<option value="20">移植科</option>
						<option value="21">放射科</option>
						<option value="22">老年科</option>
						<option value="23">介入科</option>
						<option value="24">淋巴内科</option>
						<option value="25">病理科</option>
						<option value="26">心内科</option>
						<option value="27">血管外科</option>
						<option value="28">儿科</option>
						<option value="100">全科</option>
					</select>
					<label class="control-label">医院</label>
																<select class="form-control">
																	<option>请选择科室</option>
																	<option ng-repeat="x in departmentList" value="{{x.idx}}">{{x.departmentName}}</option>
																</select>
				</form> -->
				<hr>
				<!-- <ul id="docList"></ul> -->
				<div class="ps-products">
					<div class="ps-product__columns" id="docList">
							...
							<div class="ps-shoe mb-30">
								...
								<div class="ps-shoe__content">
									 <div class="ps-shoe__variants">
										...
										<p style="overflow:auto"><span class="pull-left">副主任医师/副教授</span><span class="pull-right">上海-静安区</span></p>
									</div> 
										...
										"<div class=\"ps-shoe mb-30\">"+
											"<div class=\"ps-shoe__thumbnail\">"+
												...
												"<img src=\"http://app.qiwang-sh.com"+item.portraitPath+"\">"+
													"<a class=\"ps-shoe__overlay\" href=\"javascript:;\"></a>"+
											"</div>"+
											"<div class=\"ps-shoe__content\">"+
												" <div class=\"ps-shoe__variants\">"+
