...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${basePath}hadmin/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="${basePath}hadmin/css/demo/webuploader-demo.css">
...
<body class="gray-bg">
    ...
    <script type="text/javascript">
        ...
        // 添加全局站点信息
        var BASE_URL = basePath+'hadmin/js/plugins/webuploader';
    </script>
    <script src="${basePath}hadmin/js/plugins/webuploader/webuploader.min.js"></script>

    <script src="${basePath}hadmin/js/plugins/webuploader/demo.js"></script>
