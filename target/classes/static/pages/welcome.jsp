...
<body class="gray-bg">
                        ...
                        <div class="ibox">
                            <div class="ibox-title">
                                ...
                                <div class="ibox-tools">
                                    ...
                                    <a onclick="test();" class="btn btn-primary btn-xs">创建新项目</a>
                                </div>
                            </div>
    ...
    <!-- Flot -->
    <script src="${basePath}hadmin/js/plugins/flot/jquery.flot.js"></script>
    <script src="${basePath}hadmin/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${basePath}hadmin/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${basePath}hadmin/js/plugins/flot/jquery.flot.pie.js"></script>
    <!-- 自定义js -->
    <script src="${basePath}hadmin/js/content.js"></script>
    <!--flotdemo-->
