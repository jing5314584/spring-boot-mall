...
<head>
	...
	<link  href="${basePath}assets/css/beyond.min.css" rel="stylesheet" type="text/css" />
    <!--Beyond styles-->
    <link  href="${basePath}assets/css/beyond.min.css" rel="stylesheet" type="text/css" />
...
<body>
                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                    <li>
                                        <a href="#">
                                            <img src="${basePath}assets/img/avatars/divyia.jpg" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="${basePath}assets/img/avatars/bing.png" class="message-avatar" alt="Microsoft Bing">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Bing.com
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="${basePath}assets/img/avatars/adam-jansen.jpg" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Nicolas
                                                </span>
                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                    <div class="avatar" title="View your public profile">
                                        <img src="${basePath}assets/img/avatars/adam-jansen.jpg">
                                    </div>
                                    <section>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li>
                                        <div class="avatar-area">
                                            <img src="${basePath}assets/img/avatars/adam-jansen.jpg" class="avatar">
                                    ...
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="#" style="background-color:#5DB2FF;" rel="${basePath}assets/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#2dc3e8;" rel="${basePath}assets/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#03B3B2;" rel="${basePath}assets/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#53a93f;" rel="${basePath}assets/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#FF8F32;" rel="${basePath}assets/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#cc324b;" rel="${basePath}assets/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#AC193D;" rel="${basePath}assets/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#8C0095;" rel="${basePath}assets/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#0072C6;" rel="${basePath}assets/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#585858;" rel="${basePath}assets/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#474544;" rel="${basePath}assets/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#001940;" rel="${basePath}assets/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left no-padding bordered-left-2 bordered-palegreen">
                                            <img src="${basePath}assets/img/avatars/John-Smith.jpg" style="width:65px; height:65px;">
                                        </div>
                                                ...
                                                <div class="tickets-container">
                                                    <ul class="tickets-list">
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${basePath}assets/img/avatars/adam-jansen.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${basePath}assets/img/avatars/divyia.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${basePath}assets/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${basePath}assets/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="${basePath}assets/img/avatars/John-Smith.jpg" class="user-avatar">
    ...
    <script src="${basePath}assets/js/charts/sparkline/jquery.sparkline.js"></script>
    <script src="${basePath}assets/js/charts/sparkline/sparkline-init.js"></script>

    <!--Easy Pie Charts Needed Scripts-->
    <script src="${basePath}assets/js/charts/easypiechart/jquery.easypiechart.js"></script>
    <script src="${basePath}assets/js/charts/easypiechart/easypiechart-init.js"></script>

    <!--Flot Charts Needed Scripts-->
    <script src="${basePath}assets/js/charts/flot/jquery.flot.js"></script>
    <script src="${basePath}assets/js/charts/flot/jquery.flot.resize.js"></script>
    <script src="${basePath}assets/js/charts/flot/jquery.flot.pie.js"></script>
    <script src="${basePath}assets/js/charts/flot/jquery.flot.tooltip.js"></script>
    <script src="${basePath}assets/js/charts/flot/jquery.flot.orderBars.js"></script>
