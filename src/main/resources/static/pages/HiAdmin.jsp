...
<link href="${basePath}hadmin/css/bootstrap.min.css?v=3.3.6"
	rel="stylesheet">
<link href="${basePath}hadmin/css/font-awesome.min.css?v=4.4.0"
	rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg"
	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
						...
						<a data-toggle="dropdown" class="dropdown-toggle" href="#">
							<span class="clear">
								<span class="block m-t-xs" style="font-size:20px;">
									...
									<strong class="font-bold">天追梦人心</strong>
								</span>
							</span>
						</a>
					</div>
				...
				<li>
					<a class="J_menuItem" href="${basePath}pages/welcome.jsp">
					...
					<ul class="nav nav-second-level">
						...
						<li>
							...
							<ul class="nav nav-third-level">
								<li>
									<a class="J_menuItem" href="${basePath}pages/form_webuploader.jsp">百度WebUploader</a>
								</li>
								<li>
					...
					<ul class="nav nav-second-level">
						...
						<li>
							...
							<ul class="nav nav-third-level">
								...
								<li>
									<a class="J_menuItem" href="tree_view.html">Bootstrap Tree
										View</a>
								</li>
								<li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
						...
						<ul class="dropdown-menu dropdown-messages">
								...
								<div class="dropdown-messages-box">
									<a href="profile.html" class="pull-left">
										<img alt="image" class="img-circle"
											src="${basePath}hadmin/img/a7.jpg">
									</a>
							...
							<li>
								<div class="dropdown-messages-box">
									<a href="profile.html" class="pull-left">
										<img alt="image" class="img-circle"
											src="${basePath}hadmin/img/a4.jpg">
									</a>
									<div class="media-body ">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe id="J_iframe" width="100%" height="100%"
					src="${basePath}pages/welcome.jsp" frameborder="0"
					data-id="${basePath}pages/welcome.jsp" seamless></iframe>
			</div>
		</div>
		<!--右侧部分结束-->
	</div>
	...
	<script
		src="${basePath}hadmin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
	<script
		src="${basePath}hadmin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
	<script src="${basePath}hadmin/js/plugins/layer/layer.min.js"></script>

	<!-- 自定义js -->
	<script src="${basePath}hadmin/js/hAdmin.js?v=4.1.0"></script>
	<script type="text/javascript" src="${basePath}hadmin/js/index.js"></script>
</body>
